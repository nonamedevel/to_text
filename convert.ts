...
function getGenderSpecific(num: number, gender: string) {
    if (num === 1) {
        if (gender === 'f') {
            return 'одна'
        }
...
function detectGender(unitArr?: UnitForms) {
    if (!unitArr) {
        return 'm'
    }
...
function convertNumberToRussianWords(num: number, unitArr?: UnitForms) {
...
function selectRussianPluralForm(num: number, unitArr: UnitForms) {
    let form
...
Object.defineProperty(Number.prototype, 'toText', {
    configurable: true,
    writable: true,
    value: function (unitArr?: UnitForms) {
